...
List<double> triAxialHighpassFilter(double prevReadX, double prevReadY, double prevReadZ,
  ...
  //Low-Pass Filter
  double filteredReadX = (currReadX * smoothingParam) + prevReadX * (1 - smoothingParam);
  double filteredReadY = (currReadY * smoothingParam) + prevReadY * (1 - smoothingParam);
  double filteredReadZ = (currReadZ * smoothingParam) + prevReadZ * (1 - smoothingParam);

  // High-Pass Filter
  filteredReadX = double.parse((currReadX - filteredReadX).toStringAsPrecision(6));
